-- Structure only. Mutable demo data is created insert-only by the bootstrap service,
-- never by a startup SQL script that overwrites existing administrator changes.
SET NAMES utf8mb4;
