  ...
  <section class="settings-form">
    <template v-if="section === 'sources'">
      <div class="form-grid">
        ...
        <label class="field switch-field"><span><b>AI 智能标准化</b><small>配置 DeepSeek Key 后将标题、采购词与选品理由统一为英语</small></span><input v-model="draft.smartMode" type="checkbox" role="switch" /></label>
    ...
    <template v-else>
      <div class="form-grid">
        ...
        <label class="field"><span>每日报表商品数</span><input v-model.number="draft.maxProducts" type="number" min="1" max="500" /></label>
